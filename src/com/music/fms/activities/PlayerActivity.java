...
import com.music.fms.adapters.PlayerListAdapter;
import com.music.fms.core.*;
import com.music.fms.models.FileSystemSong;
import com.music.fms.models.PlayAbleSong;
import com.music.fms.views.GlowButton;
import com.music.fms.widgets.PlayerSliding;
...
public class PlayerActivity extends BaseActivity implements Player.PlayerListener{
    ...
    private void refreshProgress() {
        ...
        if (status != null) {
            ...
            pausePlayBTN.setSelected(status.isPlaying());
        }
    ...
    public void onActionApplied() {
        ...
        if (status != null){
            pausePlayBTN.setSelected(status.isPlaying());
            loopBTN.setSelected(status.isLoop());
            shuffleBTN.setSelected(status.isShuffle());
        }else {
